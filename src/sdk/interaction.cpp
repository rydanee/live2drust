...
extern "C" {
  ...
  void* ReadBlobAligned(const char* filePath, size_t alignment, unsigned int* outSize) {
  ...
  int load_model() {
    mocMemory = ReadBlobAligned((cargo_manifest + "/models/runtime/zundamon.moc3").c_str(), csmAlignofMoc, &mocSize);
